## Describes a weapon discipline — the starting weapon family
## (Sword / Bow / Staff / Dagger / Beginner) and its passive scaling.
## Players pick a discipline at character creation; tier-2 advancement
## disciplines (Crusader / Ranger / Archmage / Assassin) are reached at
## level 30 via the Job Advancement system. Previously named ClassData.
class_name WeaponDisciplineData
extends Resource

@warning_ignore("unused_private_class_variable")
@export var _discipline_name: String
