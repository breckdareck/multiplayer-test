...
const BUFFER := 4
const MAPS := ["lanterns_rest", "near_wilds", "meadow_path", "ember_meadows", "ruins", "three_terraces", "old_battlefield", "thornroot", "dust_warren", "mines", "emberwatch", "deep_woods", "keep", "mustering_fields", "emberscar", "cinderwaste", "ashvigil", "weave", "warlord", "bramble_downs", "bandit_bluffs", "the_undercroft", "the_scorchline", "the_unraveling"]
